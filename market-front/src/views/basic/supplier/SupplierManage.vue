<template>
  <div>
      ...
      <el-row>
        ...
        <el-col :span="22">
          <el-form :model="searchData" :inline="true">
            <el-form-item>
              <el-input type="text" placeholder="供应商名" v-model="searchData.name" clearable
    ...
    <!-- 新增对话框 -->
    <AddSupplier :addDialogVisible="addDialogVisible" @closeDialog="addDialogVisible = false"
      @addSuccess="handleAddSuccess"></AddSupplier>
    <!-- 更新对话框 -->
    <UpdateSupplier :updateDialogVisible="updateDialogVisible" @closeDialog="updateDialogVisible = false"
      :idToUpdate="idToUpdate" @updateSuccess="handleUpdateSuccess"></UpdateSupplier>
  </div>
</template>
<script setup name='SupplierManage' lang='ts'>
import { ref, reactive, onMounted } from 'vue'
import { Plus, Edit, Delete } from '@element-plus/icons-vue';
import AddSupplier from '@/views/basic/supplier/AddSupplier.vue';
import UpdateSupplier from '@/views/basic/supplier/UpdateSupplier.vue';
import { useTable } from '@/hooks/useTable';
import { loadTableApi, deleteByIdApi } from '@/api/supplierApi';
